...
2. Create a Terraform on {{site.data.keyword.cloud_notm}} Databases project directory. The directory holds all your configuration files that you create as part of this tutorial. The directory in this tutorial is named `tf-mongodbee`, but you can use any name for the directory.
...
1. In the same project directory, create a Terraform configuration file named `mongodbee.tf`.
