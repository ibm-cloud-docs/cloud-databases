...
|----------|-----------------------|--------|
|Monitoring| {{site.data.keyword.databases-for}} is responsible for hosting monitoring and health services. | The Customer is responsible for integrating with the [Monitoring](/docs/Monitoring-with-Sysdig?topic=Monitoring-with-Sysdig-platform_metrics_enabling), [Activity Tracker](/docs/cloud-databases?topic=cloud-databases-activity-tracker), or [Log Analysis](/docs/cloud-databases?topic=cloud-databases-logging). |
