...
|Operating System | {{site.data.keyword.databases-for}} is responsible for hosting and maintaining database infrastructure. | The Customer is not responsible for, nor has access to, Operating System level activities. |
