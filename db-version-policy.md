...
| {{site.data.keyword.databases-for-redis}} | Major versions are the first number in a `major.minor.patch` version number. | v5.0, 26 April 2024; v6.0 25 October 2024 |   v7.2   | Automatically upgraded in place to next Major version 6.2 |
